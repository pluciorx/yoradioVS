...
#define YOVERSION "0.9.720 mod by PCX"
...
#define DSP_4002I2C     102   // 40x2           https://aliexpress.com/item/32812259852.html
...
/*        ESP DEVBOARD            */
#if defined(ARDUINO_ESP32S3_DEV) || defined(ARDUINO_ESP32C3_DEV) || defined(ARDUINO_NANO_ESP32)
    #define ESP_S3C3       1
